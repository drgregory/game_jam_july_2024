...
if ( ( !global.portal_blocked_p2 ) and ( other.current_sprite_index < global.num_alchemy_elements ) ) {
...
} else if ( ( !global.portal_blocked_p2 ) and ( other.current_sprite_index >= global.num_alchemy_elements ) ) {
	// hit by a monster
	alarm[ 0 ] = global.MONSTER_COLLISION_TIMEOUT;
	global.portal_blocked_p2 = true;
}
